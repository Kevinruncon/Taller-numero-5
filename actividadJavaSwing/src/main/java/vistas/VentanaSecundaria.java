...
public class VentanaSecundaria extends javax.swing.JDialog {
    ...
    public VentanaSecundaria(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        JOptionPane.showMessageDialog(this, "Este es un mensaje de la ventana secundaria", "Informacion", JOptionPane.INFORMATION_MESSAGE); /*;*/
         setVisible(true);
//        setVisible(VentanaPrincipal.set);
    }
